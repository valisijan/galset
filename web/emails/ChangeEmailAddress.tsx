  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "20px" }}>
        Evo vašeg koda za verifikaciju:
      </p>
      ...
      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Dobili smo zahtev za promenu email adrese na vašem nalogu. Ovaj kod važi kratko vreme radi vaše sigurnosti.
      </p>

      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Ako vi niste zatražili promenu email adrese, molimo vas da odmah promenite lozinku na vašem nalogu ili kontaktirate našu podršku kako biste zaštitili svoj nalog.
      </p>
