  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Dobili smo zahtev za kreiranje naloga. Ovaj kod važi kratko vreme radi vaše sigurnosti.
      </p>

      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Ako vi niste zatražili kreiranje naloga, molimo vas da ignorišete ili obrišete ovaj email.
      </p>
