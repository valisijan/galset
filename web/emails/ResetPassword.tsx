  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "20px" }}>
        Dobili smo zahtev za promenu lozinke na vašem nalogu. Kliknite na dugme ispod da bi ste nastavili:
      </p>

      <div style={{ textAlign: "center", marginBottom: "32px", marginTop: "24px" }}>
        <a
          href={`https://galset.com/auth/reset-password?token=${code}`}
          style={{
            background: "#6366f1",
            color: "#ffffff",
            padding: "16px 32px",
      ...
      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Ako niste zatražili promenu lozinke, molimo vas da ignorišete ili obrišete ovaj email, vaša lozinka će ostati ista.
      </p>
