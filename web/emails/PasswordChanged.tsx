  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "16px", lineHeight: "1.5" }}>
        Lozinka na vašem nalogu je uspešno promenjena.
      </p>

      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Ako ste vi izvršili ovu promenu, možete bezbedno zanemariti ovaj email. Ukoliko niste zatražili promenu lozinke, molimo vas da odmah kontaktirate našu podršku kako biste zaštitili svoj nalog.
      </p>
