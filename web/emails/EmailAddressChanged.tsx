...
export default function EmailAddressChanged({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "16px", lineHeight: "1.5" }}>
        Email adresa na vašem nalogu je uspešno promenjena.
      </p>

      <p>
        <span style={{ fontSize: "15px", display: "block", marginBottom: "4px" }}>Nova email adresa:</span>
        <span style={{ fontSize: "16px", color: "#6366f1", fontWeight: "bold" }}>{newEmail}</span>
      </p>

      <p style={{ fontSize: "15px", marginBottom: "24px", lineHeight: "1.5" }}>
        Ako vi niste zatražili promenu email adrese, molimo vas da odmah kontaktirate našu podršku i zaštitite svoj nalog.
      </p>
