...
export default function DeleteDraftModal({ isOpen, onClose, onConfirm, adTitle }: ModalProps) {
    ...
    useEffect(() => {
        ...
        window.history.pushState({ modal: "deleteDraft" }, "");
        ...
        return () => {
            ...
            if (window.history.state?.modal === "deleteDraft") {
                window.history.back();
            }
        };
    }, [isOpen]);
                ...
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="pt-8 pb-2 text-center">
                            <h3 className="text-text-main font-bold text-lg">Obriši radnu verziju?</h3>
                        </div>
                        ...
                        <div className="flex flex-col items-center mt-2">
                            ...
                            <div className="w-full px-6 pb-6 flex flex-col gap-3">
                                <button
                                    onClick={onConfirm}
                                    className="w-full py-3 rounded-full font-bold transition-all duration-200 text-base flex items-center justify-center bg-red-600 hover:bg-red-700 text-white cursor-pointer"
                                >
                                    Obriši
                                </button>
                                <button
