...
export default function SetAvailableModal({ isOpen, onClose, onConfirm, adTitle }: ModalProps) {
    ...
    useEffect(() => {
        ...
        window.history.pushState({ modal: "setAvailable" }, "");
        ...
        return () => {
            ...
            if (window.history.state?.modal === "setAvailable") {
                window.history.back();
            }
        };
    }, [isOpen]);
                ...
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="pt-8 pb-2 text-center">
                            <h3 className="text-text-main font-bold text-lg">Ponovo dostupno?</h3>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center mt-2">
                            <div className="mb-8 px-6 w-full text-center">
                                <p className="text-text-main opacity-70 text-[15px]">
                                    Oglas <span className="font-semibold text-text-main">{adTitle}</span> će biti označen kao <span className="font-semibold text-text-main">dostupan</span>. Rezervacija će biti uklonjena.
                                </p>
                            </div>
