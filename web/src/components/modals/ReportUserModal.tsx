...
export default function ReportUserModal({ isOpen, onClose, username, profileImg, targetId, onBack }: ReportUserModalProps) {
    ...
    useEffect(() => {
        ...
        window.history.pushState({ modal: "reportUser" }, "");
        ...
        return () => {
            ...
            if (window.history.state?.modal === "reportUser") {
                window.history.back();
            }
        };
    }, [isOpen, onBack]);
        ...
        return (
            <>
                ...
                <div className="pt-8 pb-1 text-center">
                    <h3 className="text-text-main font-bold text-lg">Prijavi korisnika</h3>
                </div>

                {/* User Info Row - PRESERVED */}
                <div className="flex items-center gap-3 px-6 pt-4 pb-2">
                    <div className="w-10 h-10 rounded-full overflow-hidden relative shrink-0 border border-bg-2">
                        <Image
                            src={profileImg?.split("|||")[0] || UserAvatar}
                            alt={username}
                            fill
                    ...
                    <p className="text-sm font-medium text-text-main">
                        Prijavi korisnika <span className="font-bold">{username}</span>
                    </p>
                </div>
