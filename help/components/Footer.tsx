            ...
            <div className="max-w-[1920px] mx-auto px-4 py-10 md:py-16">
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm font-medium text-gray-500 dark:text-gray-400">
                        ...
                        <Link href="https://galset.com/policies/terms-of-use" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Uslovi korišćenja</Link>
                        <Link href="https://galset.com/policies/privacy-policy" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Politika privatnosti</Link>
                        <Link href="https://galset.com/policies/cookie-policy" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Politika kolačića</Link>
                        <button
                        ...
                        <Link href="https://galset.com/policies/community-guidelines" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Smernice zajednice</Link>
                        <Link href="https://galset.com/policies/credits" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Galset krediti</Link>
                        <Link href="https://galset.com/pricing" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Cenovnik</Link>
                        <button
                        ...
                        <Link href="/" className="hover:text-text-main dark:hover:text-white transition-colors duration-200">Pomoć</Link>
                    </div>
