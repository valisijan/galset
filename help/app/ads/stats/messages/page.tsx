...
export default function AdsStatsMessagesPage() {
    return (
        <HelpLayout pageTitle="Kako videti broj poruka oglasa?" hideWrapper={true}>
            <div className="space-y-12 max-w-3xl">
                <div className="space-y-8">
                    ...
                    <div className="pt-6 text-gray-700 dark:text-gray-300 space-y-4">
                        <p>
                            Broj poruka za vaš oglas možete videti u njegovom donjem desnom uglu, pored <MessageSquare className="inline-block w-5 h-5 mx-1 text-[#6366f1] mb-1" /> ikonice.
                        </p>
                        <p>
                            Ovaj broj predstavlja koliko ste poruka i započetih četova dobili direktno za taj konkretan oglas.
                        </p>
                    </div>
                </div>
            </div>
