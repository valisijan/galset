...
import { Menu, MoreVertical, SquarePen } from 'lucide-react';

export default function AdsManageEditPage() {
    return (
        <HelpLayout pageTitle="Kako izmeniti oglas?" hideWrapper={true}>
            <div className="space-y-12 max-w-3xl">
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Zatim na željenom oglasu kliknite na <MoreVertical className="inline-block w-5 h-5 mx-1 text-[#6366f1] mb-1" /> ikonicu, pa na <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><SquarePen className="w-5 h-5" /> <span className="mt-0.5">Izmeni</span></span>.
                        </p>
                    </div>
                </div>
            </div>
