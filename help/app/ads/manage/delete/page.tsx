...
export default function AdsManageDeletePage() {
    return (
        <HelpLayout pageTitle="Kako obrisati oglas?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Na oglasu koji želite da obrišete kliknite na <MoreVertical className="inline-block w-5 h-5 mx-1 text-[#6366f1] mb-1" /> ikonicu, zatim kliknite na <span className="inline-flex items-center gap-1 font-bold text-red-600 whitespace-nowrap align-middle"><Trash2 className="w-5 h-5" /> <span className="mt-0.5">Obriši</span></span>.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                            U prozoru koji se otvori, potvrdite brisanje klikom na <span className="text-red-600 font-bold">Obriši</span>.
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Zatim na željenom oglasu kliknite na <MoreVertical className="inline-block w-5 h-5 mx-1 text-[#6366f1] mb-1" /> ikonicu, pa na <span className="inline-flex items-center gap-1 font-bold text-red-600 whitespace-nowrap align-middle"><Trash2 className="w-5 h-5" /> <span className="mt-0.5">Obriši</span></span>.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                            Potvrdite akciju u prozoru koji se pojavi klikom na crveni tekst <span className="text-red-600 font-bold">Obriši</span>.
                        </p>
                    </div>
                </div>
            </div>
