...
export default function NotificationsTurnOffPage() {
    return (
        <HelpLayout pageTitle="Kako isključiti obaveštenja?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste isključili obaveštenja,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Isključite prekidače za kategorije obaveštenja koje više ne želite da primate (npr. Oglasi, Poruke, Nalog) i kliknite na dugme <span className="text-[#6366f1] font-bold">Primeni</span>.
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Odaberite kategorije koje želite da isključite i potvrdite izmene klikom na dugme <span className="text-[#6366f1] font-bold">Primeni</span>.
                        </p>
                    </div>
