...
export default function LanguageSettingsPage() {
    return (
        <HelpLayout pageTitle="Kako promeniti jezik?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste promenili jezik aplikacije,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Kliknite na <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><Languages className="w-5 h-5" /> <span className="mt-0.5">Jezik</span></span>, zatim izaberite željeni jezik.
                        </p>
                        <p className="text-gray-500 dark:text-gray-400 italic pt-2">
                            Napomena: Trenutno je dostupan samo Srpski jezik.
                        </p>
                    </div>
