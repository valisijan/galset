...
export default function ThemeSettingsPage() {
    return (
        <HelpLayout pageTitle="Kako promeniti temu?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste promenili temu aplikacije,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Kliknite na <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><SunMoon className="w-5 h-5" /> <span className="mt-0.5">Izgled</span></span>, zatim kliknite na <span className="text-[#6366f1] font-bold">Tema</span>.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                            U prozoru koji se otvori odaberite željenu temu i kliknite na <span className="text-[#6366f1] font-bold">Primeni</span>.
                        </p>
                    </div>
