...
export default function LogoutAllDevicesPage() {
    return (
        <HelpLayout pageTitle="Kako se odjaviti sa svih uređaja?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste se odjavili sa svih uređaja,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Kliknite na <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><Lock className="w-5 h-5" /> <span className="mt-0.5">Bezbednost</span></span>, skrolujte do dna i kliknite na <span className="inline-flex items-center gap-1 font-bold text-red-600 whitespace-nowrap align-middle"><LogOut className="w-5 h-5" /> <span className="mt-0.5">Odjavi se sa svih uređaja</span></span>.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
