...
export default function DeactivateAccountPage() {
    return (
        <HelpLayout pageTitle="Kako deaktivirati nalog?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste deaktivirali vaš nalog,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Kliknite na <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><HatGlasses className="w-5 h-5" /> <span className="mt-0.5">Privatnost</span></span>, zatim kliknite na <span className="text-red-600 font-bold">Deaktiviraj nalog</span>.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                            U prozoru koji se otvori, štiklirajte polje za potvrdu, zatim kliknite na <span className="text-red-600 font-bold">Deaktiviraj nalog</span>.
                        </p>
                    </div>
