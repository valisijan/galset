...
export default function EditDescriptionPage() {
    return (
        <HelpLayout pageTitle="Kako izmeniti opis profila?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste izmenili opis vašeg profila,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Izaberite opciju <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><UserPen className="w-5 h-5" /> <span className="mt-0.5">Uredi profil</span></span>, pronađite polje <span className="text-[#6366f1] font-bold">Opis profila</span> i unesite željeni tekst.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                            Nakon promene, u prozoru koji se pojavi na dnu ekrana kliknite na dugme <span className="text-[#6366f1] font-bold">Sačuvaj</span>.
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            U polje <span className="text-[#6366f1] font-bold">Opis profila</span> unesite željene informacije o vama. Pojaviće se prozor sa potvrdom gde je potrebno da kliknete na dugme <span className="text-[#6366f1] font-bold">Sačuvaj</span>.
                        </p>
                    </div>
