...
export default function EditUsernamePage() {
    return (
        <HelpLayout pageTitle="Kako izmeniti korisničko ime?" hideWrapper={true}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 pt-4 leading-relaxed">
                            Da biste izmenili vaše korisničko ime,<br />
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Izaberite opciju <span className="inline-flex items-center gap-1 font-bold text-[#6366f1] whitespace-nowrap align-middle"><UserPen className="w-5 h-5" /> <span className="mt-0.5">Uredi profil</span></span>, pronađite polje <span className="text-[#6366f1] font-bold">Korisničko ime</span> i unesite željene izmene.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            U polje <span className="text-[#6366f1] font-bold">Korisničko ime</span> unesite novi naziv. Pojaviće se prozor sa potvrdom gde je potrebno da kliknete na dugme <span className="text-[#6366f1] font-bold">Sačuvaj</span>.
                        </p>
                    </div>
